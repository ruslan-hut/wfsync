...
| POST | `/v1/wf/sync/pull` | Sync invoices from Wfirma to local DB |
| POST | `/v1/wf/sync/push` | Sync local invoices to Wfirma |
| GET | `/v1/wf/list` | Report which orders in a date range were invoiced (JSON or CSV) |
